...
Exp2=$(curl -sS https://raw.githubusercontent.com/BjhonStore/Premium/main/ip | grep $MYIP | awk '{print $3}')
...
#update
wget -q -O updatsc.sh "https://raw.githubusercontent.com/BjhonStore/Premium/main/menu/updateyes.sh" && chmod +x updatsc.sh && ./updatsc.sh 

# // Exporting IP Address
export MYIP=$( curl -s https://ipinfo.io/ip/ )
Name=$(curl -sS https://raw.githubusercontent.com/BjhonStore/Premium/main/ip | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/BjhonStore/Premium/main/ip | grep $MYIP | awk '{print $3}')
